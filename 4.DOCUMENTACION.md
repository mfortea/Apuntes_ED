...
- Comandos
    ...
    - git add -> Registra todos los cambios (git add . -> Lo añade todo)
    - git commit -> Confirmamos el estado de esos archivos en el repositorio.
    - git push -> Para subir los cambios.
    - git pull -> Hace lo contrario al push. Descarga los archivos.
